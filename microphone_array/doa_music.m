...
n = 500;                 % ²ÉÑùÊı
%------------------------------------------------------¹¹½¨½ÓÊÕÄ£ĞÍ£¬ºÍĞÅºÅÄ£ĞÍ---------------------------------------------------------%
A=exp(-j*twpi*d.'*sin(theta*derad));%%%% direction matrix·½ÏòÊ¸Á¿,ÕóÁĞÁ÷ĞÎ
...
%Rxx=X1*X1'/n;   %¼ÆËãĞ­·½²î¾ØÕó,ÕâÀïÊÇĞ­·½²î¾ØÕóµÄ¹À¼ÆÖµ
...
for iang = 1:361 %Í¨¹ı±ä»¯¦ÈËÑË÷¿Õ¼äÆ×
        ...
        a=exp(-j*twpi*d*sin(phim)).'; %ĞÅºÅµÄÌØÕ÷ÏòÁ¿
...
[Te,A]=sort(SP);  %´Ë´¦ÅÅĞò
[l,p]=findpeaks(SP,3);%ËÑË÷Æ×·åº¯Êı
